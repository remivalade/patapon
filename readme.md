...
- Les lacs reflètent le monde : ciel, rives, arbres, pont et Marceau se mirent dans l'eau, plus nettement quand on regarde à ras de la surface. Des ronds dans l'eau qui se propagent vraiment quand on nage, quand la barque avance ou qu'un poisson frôle la surface, avec la lumière qui se concentre au fond là où l'eau se soulève. Ces deux effets ne sont dessinés que près d'un lac, et le reflet se coupe de lui-même si l'appareil ne tient pas 30 images par seconde.
...
| `src/landscape.js`            | Grand lac, pont-chaussée et pont suspendu, île, système de jour/nuit, vitesse du cache et éclairage disco                                                                                               |
| `src/water.js`                | Rendu et animation de l'eau : couleur, reflet projeté, normales et caustiques tirées des ondulations                                                                                                    |
| `src/reflection.js`           | Reflet des lacs : la scène redessinée en basse résolution depuis une caméra miroir sous l'eau, avec garde-fou de fluidité                                                                               |
| `src/ripples.js`              | Ondulations : champ de hauteurs calculé sur la carte graphique dans une fenêtre autour du joueur, ronds du nageur, de la barque et des poissons                                                         |
