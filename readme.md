...
| `src/world.js`                | Le jeu complet, créé par `createGame` : scènes, personnage, interactions, caméra et boucle de jeu. Rend une porte d'entrée stable (commandes, `place`, `state`, `parts`) utilisée par les tests |
